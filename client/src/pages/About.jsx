  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-slate-800/70 border border-slate-700/60 rounded-2xl p-8 space-y-6 text-slate-300 text-sm leading-relaxed">
        <p>NFL Data Platform is a statistics explorer built for fans who want to go deeper than the box score.</p>
        ...
        <div>
          ...
          <p>Statistics are sourced from multiple data providers and cover the 1970–2025 regular seasons. Different data types have different coverage windows — see the in-app Guide for full details.</p>
        </div>
