...
export const api = {
  ...
  saveAnecdote: (query, text, level, language, scheduled_date) => post('/anecdote/save', { query, text, level, language, scheduled_date }),
  ...
  getEpaRankings: (params = {}) => {
    ...
    if (params.teams?.length) p.set('team', params.teams.join(','))
